...
const Sidebar = () => {
    ...
    return (
        <ul className="navbar-nav sidebar sidebar-dark " id="accordionSidebar" style={{ backgroundColor: '#1b2674' }}>
            ...
            {/* Assistance Section */}
             <li className="nav-item">
                <a className="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseAssistance" aria-expanded="true" aria-controls="collapseAssistance">
                ...
                <div id="collapseAssistance" className="collapse" aria-labelledby="headingAssistance" data-parent="#accordionSidebar">
                    <div className="bg-white py-2 collapse-inner rounded">
                        {/* Réclamations */}
                        <a className="collapse-item" href="#" style={{ fontWeight: 'bold' , color:'#f48404' }} onClick={() => toggleSection('reclamations')}>Réclamations</a>
                        ...
                        {/* Demandes */}
                        <a className="collapse-item" href="#" style={{ fontWeight: 'bold', color:'#f48404' }} onClick={() => toggleSection('demandes')}>Demandes</a>
            ...
            <li className="nav-item">
                <a className="nav-link" href="#collapseMigration" data-toggle="collapse" aria-expanded="true">
            ...
            <li className="nav-item">
                <a className="nav-link" href="#collapseTransfert" data-toggle="collapse" aria-expanded="true">
            ...
            <li className="nav-item">
                <a className="nav-link" href="#collapseSuggestion" data-toggle="collapse" aria-expanded="true">
