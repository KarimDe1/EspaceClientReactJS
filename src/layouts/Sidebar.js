...
const Sidebar = () => {
    ...
    return (
        <ul className="navbar-nav sidebar sidebar-dark" id="accordionSidebar" style={{ backgroundColor: '#1b2674' }}>
            ...
            {/* Assistance Section */}
            <li className="nav-item">
                <a className="nav-link collapsed"  data-toggle="collapse" data-target="#collapseAssistance" aria-expanded="true" aria-controls="collapseAssistance" onClick={() => toggleSection('collapseAssistance')}>
